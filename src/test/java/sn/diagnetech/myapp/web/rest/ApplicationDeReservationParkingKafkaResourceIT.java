...
import sn.diagnetech.myapp.config.KafkaProperties;

class ApplicationDeReservationParkingKafkaResourceIT {
    ...
    void setup() {
        ...
        ApplicationDeReservationParkingKafkaResource kafkaResource = new ApplicationDeReservationParkingKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/application-de-reservation-parking-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/application-de-reservation-parking-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
