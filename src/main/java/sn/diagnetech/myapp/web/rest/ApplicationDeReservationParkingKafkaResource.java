...
@RestController
@RequestMapping("/api/application-de-reservation-parking-kafka")
public class ApplicationDeReservationParkingKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ApplicationDeReservationParkingKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ApplicationDeReservationParkingKafkaResource(KafkaProperties kafkaProperties) {
